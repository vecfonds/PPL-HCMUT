...
array_type: ARRAY LSB dimensions RSB OF primitive_type;
...
bodymethod: stmt | var_decl; // | special_function;
...
/* ---------- SPECIAL FUNCTION ---------- */
// special_function: readinteger | printinteger | readfloat | writefloat | readboolean |
// printboolean | readstring | printstring | super_function | preventdefault; readinteger:
// 'readInteger' LB RB SEMI; printinteger: 'printInteger' LB list_exp RB SEMI; readfloat:
// 'readFloat' LB RB SEMI; writefloat: 'writeFloat' LB list_exp RB SEMI; readboolean: 'readBoolean'
// LB RB SEMI; printboolean: 'printBoolean' LB list_exp RB SEMI; readstring: 'readString' LB RB
// SEMI; printstring: 'printString' LB list_exp RB SEMI; super_function: 'super' LB list_exp RB
// SEMI; preventdefault: 'preventDefault' LB RB SEMI;
