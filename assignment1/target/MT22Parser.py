...
class MT22Parser ( Parser ):
    ...
    class Vardecl_normalContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVardecl_normal" ):
                return visitor.visitVardecl_normal(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Vardecl_symmetricContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVardecl_symmetric" ):
                return visitor.visitVardecl_symmetric(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Param_listsContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitParam_lists" ):
                return visitor.visitParam_lists(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Statement_assignmentContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatement_assignment" ):
                return visitor.visitStatement_assignment(self)
            else:
                return visitor.visitChildren(self)
    ...
    class If0Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitIf0" ):
                return visitor.visitIf0(self)
            else:
                return visitor.visitChildren(self)
    ...
    class True_false_statementContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitTrue_false_statement" ):
                return visitor.visitTrue_false_statement(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Statement_do_whileContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatement_do_while" ):
    ...
    class Statement_continueContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatement_continue" ):
    ...
    class Statement_callContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatement_call" ):
                return visitor.visitStatement_call(self)
            else:
                return visitor.visitChildren(self)
    ...
    class BodymethodsContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitBodymethods" ):
                return visitor.visitBodymethods(self)
            else:
                return visitor.visitChildren(self)
